...
export const representative = {
  ...
  greeting: [
    ...
    '私が日々感じているのは、今の日本にはどこか余裕のなさが広がり、以前よりも人や社会の空気が少しずつ荒れてきているのではないか、ということです。だからこそ、微力ではありますが、自分にできることで少しでも良い方向へ動かしていければと考えることが多くなりました。そんな想いを持ちながら、この工房を営んでいます。',
    'そんな中で出会ったのが、AIという新しい技術でした。\n最初は正直、とても戸惑いがありました。人間らしさや、人にしかできないことこそ大切だと思っていたからです。ですが、AIに関わっていく中で、この大きな流れはもう止めることができないものだとも強く感じるようになりました。',
    ...
    '杜の都工房は、私が一方的に教える場所ではありません。\n同じ目線で考え、悩み、試しながら、一緒にこれからの時代をつくっていく。そんな仲間のような存在でありたいと思っています。',
