...
export const about = {
  name: '杜の都工房について',
  title: 'AIとデザインで、\n「考える・作る・進める」を自然に。',
  lead: '宮城・仙台を拠点に、Webサイト制作とAI活用支援を行う小さな工房です。',
  bio: [
    {
      heading: 'はじめての方も、安心して。',
      body: '「新しいことを取り入れたいけど、何から始めたらいいかわからない」「外注したいけど、思いをうまく伝えられない」。そんなモヤモヤを、対話しながら一緒にほどいていく工房です。',
    },
    {
      heading: 'AIに振り回されず、自分らしく。',
      body: 'AIで効率化することが目的ではありません。事業やサービスの背景にある想いを丁寧に伺い、AIと人それぞれの得意を活かして、いちばん合うやり方で形にします。',
    },
    {
      heading: '地方から、新しい当たり前を。',
      body: '東北からでも、技術を味方につければ、表現や仕事の可能性は大きく広がる。地域に、県に、東北全体に。少しずつ良い影響を広げていくことが、私たちの目指す未来です。',
    },
  ],
  skills: [],
