      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-24 pb-20 md:pt-36 md:pb-32">
          ...
          <div className="relative mx-auto max-w-4xl px-5 text-center md:px-8">
            ...
            <p className="mx-auto mb-10 max-w-lg text-sm leading-relaxed text-[#718096] md:text-base">
              AIを使いこなすのではなく、AIと共に生きる。<br />
              話すだけで、仕事が前に進む自分へ。<br className="hidden sm:block" />
              理解してから始めるのではなく、始めながら進化していく。
            </p>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
              {[
                ...
                <div key={i} className="rounded-2xl border border-[#e2e8f0] bg-white p-5 transition-all hover:shadow-md">
                  <span className="mb-3 block text-2xl">{item.icon}</span>
                  <p className="text-sm leading-relaxed text-[#4a5568] whitespace-pre-line">{item.text}</p>
                </div>
              ))}
            </div>
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            ...
            <div className="mb-10 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#e2e8f0] bg-[#f7fafc] p-6 md:p-8">
                <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[#e2e8f0] px-3 py-1">
                  <span className="text-xs font-semibold text-[#718096]">学ぶ</span>
                </div>
              ...
              <div className="rounded-2xl border border-cyan-200 bg-gradient-to-br from-cyan-50 to-blue-50 p-6 md:p-8">
                <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 px-3 py-1">
                  <span className="text-xs font-semibold text-white">アップデート</span>
                </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                },
                {
                  icon: '🤝',
                  title: 'ひとりで抱え込まない',
                  text: 'AIは24時間いつでも相談できるパートナー。壁打ち相手として、思考の整理から実行まで一緒に進めます。',
                },
                {
                  icon: '🚀',
                  title: '自走できる自分になる',
                  text: '最終的には、自分自身でAIと会話しながら、仕事や事業を前に進められる状態を目指します。',
                },
              ].map((item, i) => (
                <div key={i} className="rounded-2xl border border-white bg-white p-6 shadow-sm transition-all hover:shadow-md md:p-8">
                  <span className="mb-4 block text-3xl">{item.icon}</span>
                  <h3 className="mb-2 text-base font-bold text-[#2d3748]">{item.title}</h3>
                  <p className="text-sm leading-relaxed text-[#718096]">{item.text}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:gap-4">
              {[
                ...
                <div key={i} className="group flex flex-col items-center rounded-2xl border border-[#e2e8f0] bg-white p-5 text-center transition-all hover:border-cyan-200 hover:shadow-md">
                  <span className="mb-3 text-2xl transition-transform group-hover:scale-110">{item.icon}</span>
                  <span className="text-xs font-medium leading-relaxed text-[#4a5568] whitespace-pre-line md:text-sm">{item.label}</span>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  num: '04',
                  title: '自走できる状態へ',
                  text: '最終的には、あなた自身がAIに相談し、AIと共に前進し、必要なものを形にできる状態を一緒に目指します。',
                },
              ].map((step, i) => (
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4">
              {[
                ...
                <div key={i} className="flex flex-col items-center rounded-2xl bg-white p-5 shadow-sm transition-all hover:shadow-md">
                  <span className="mb-2 text-2xl">{item.icon}</span>
                  <span className="text-sm font-semibold text-[#2d3748] whitespace-pre-line text-center">{item.title}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {/* 向いている人 */}
              <div className="rounded-2xl border border-cyan-200 bg-gradient-to-br from-cyan-50/50 to-blue-50/50 p-6 md:p-8">
                <h3 className="mb-5 flex items-center gap-2 text-base font-bold text-cyan-700">
                  <span className="flex h-7 w-7 items-center justify-center rounded-full bg-cyan-500 text-sm text-white">✓</span>
                  向いている方
                </h3>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-2 text-sm leading-relaxed text-[#4a5568]">
              ...
              {/* 向いていない人 */}
              <div className="rounded-2xl border border-[#e2e8f0] bg-[#f7fafc] p-6 md:p-8">
                <h3 className="mb-5 flex items-center gap-2 text-base font-bold text-[#718096]">
                  <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#cbd5e0] text-sm text-white">×</span>
                  向いていない方
                </h3>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-2 text-sm leading-relaxed text-[#718096]">
                      <span className="mt-0.5 text-[#cbd5e0]">●</span>
                      {item}
                    </li>
                  ))}
                </ul>
